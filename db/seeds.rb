...
okay = Collection.create(name: 'Okay Bears',
                         image: 'https://bafkreidgfsdjx4nt4vctch73hcchb3pkiwic2onfw5yr4756adchogk5de.ipfs.dweb.link/', description: 'A cool nft collection.', symbol: 'OB', supply: 10_000, listings: 984, floor_price: 140, category: 'Gaming', website: '#', twitter: '#', discord: '#', volume: 1_245_532, volume24: 20)
smb = Collection.create(name: 'Solana Monkey Business', image: 'https://i.imgur.com/bMH6qNc.png',
                        description: 'A cool nft collection.', symbol: 'SMB', supply: 5555, listings: 459, floor_price: 26, category: 'Gaming', website: '#', twitter: '#', discord: '#', volume: 34_234, volume24: 25)
degods = Collection.create(name: 'DeGods', image: 'https://i.imgur.com/fO3tI1t.png',
                           description: 'A cool nft collection.', symbol: 'DG', supply: 8888, listings: 200, floor_price: 340, category: 'Gaming', website: '#', twitter: '#', discord: '#', volume: 4_353_456, volume24: 2)
cets = Collection.create(name: 'CETS ON CRECK',
                         image: 'https://creator-hub-prod.s3.us-east-2.amazonaws.com/cats_on_crack_pfp_1644850873089.png', description: 'A cool nft collection.', symbol: 'COC', supply: 10_000, listings: 1035, floor_price: 20, category: 'Gaming', website: '#', twitter: '#', discord: '#', volume: 468_689, volume24: 1)

# Sports
stepn = Collection.create(name: 'STEPN',
                          image: 'https://dl.airtable.com/.attachmentThumbnails/d5c12b4eb46e676d72569a2084345c94/6ef0628f', description: 'A cool nft collection.', symbol: 'STPN', supply: 4444, listings: 227, floor_price: 5, category: 'Sports', website: '#', twitter: '#', discord: '#', volume: 213_412, volume24: 30)
...
creamy = Collection.create(name: 'Creamy Friends',
                           image: 'https://creator-hub-prod.s3.us-east-2.amazonaws.com/creamy_friends_pfp_1650234862751.png', description: 'A cool nft collection.', symbol: 'CF', supply: 6666, listings: 129, floor_price: 2.8, category: 'Sports', website: '#', twitter: '#', discord: '#', volume: 354_363, volume24: 19)
...
mous = Collection.create(name: 'Mous in da hous',
                         image: 'https://creator-hub-prod.s3.us-east-2.amazonaws.com/midh_pfp_1650739885263.png', description: 'A cool nft collection.', symbol: 'MIDH', supply: 3366, listings: 3097, floor_price: 1.5, category: 'Metaverse', website: '#', twitter: '#', discord: '#', volume: 2_790_787, volume24: 21)
block = Collection.create(name: 'Blocksmith Labs',
                          image: 'https://dl.airtable.com/.attachmentThumbnails/b1aabaad68ef1a7512de6a0ddd15f38d/47c53a89', description: 'A cool nft collection.', symbol: 'BL', supply: 9999, listings: 230, floor_price: 20, category: 'Metaverse', website: '#', twitter: '#', discord: '#', volume: 13_453_464, volume24: 20)

# Music
trippin = Collection.create(name: 'Trippin Ape Tribe', image: 'https://i.imgur.com/iFgvQva.png',
                            description: 'A cool nft collection.', symbol: 'TAT', supply: 11_111, listings: 1003, floor_price: 18, category: 'Music', website: '#', twitter: '#', discord: '#', volume: 623_456, volume24: 20)
gemmy = Collection.create(name: 'Gemmy',
                          image: 'https://creator-hub-prod.s3.us-east-2.amazonaws.com/gemmy_pfp_1651420536407.png', description: 'A cool nft collection.', symbol: 'GMY', supply: 10_000, listings: 816, floor_price: 9.3, category: 'Music', website: '#', twitter: '#', discord: '#', volume: 23_455, volume24: 15)
ths = Collection.create(name: 'Tombstoned High Society',
                        image: 'https://creator-hub-prod.s3.us-east-2.amazonaws.com/tombstoned_pfp_1645169267186.gif', description: 'A cool nft collection.', symbol: 'THS', supply: 10_000, listings: 78, floor_price: 20.7, category: 'Music', website: '#', twitter: '#', discord: '#', volume: 45_478, volume24: 26)
...
fff = Collection.create(name: 'Famous Fox Federation',
                        image: 'https://bafybeiglipep6klutky4atw7jhf7lknpgzbfqlmqmamqh5s6lwih6uopma.ipfs.dweb.link/', description: 'A cool nft collection.', symbol: 'FFF', supply: 4545, listings: 422, floor_price: 125, category: 'Utility', website: '#', twitter: '#', discord: '#', volume: 123_467, volume24: 4)
tsf = Collection.create(name: 'The Stoned Frogs',
                        image: 'https://bafybeig36sok3pfoxsms6x6wfaizt6m2qtqmmxpun4au3kvdypz6pxqdem.ipfs.dweb.link/', description: 'A cool nft collection.', symbol: 'TSF', supply: 8787, listings: 521, floor_price: 15, category: 'Utility', website: '#', twitter: '#', discord: '#', volume: 323_456, volume24: 17)
...
vault = Collection.create(name: 'The X-Vault DAO',
                          image: 'https://creator-hub-prod.s3.us-east-2.amazonaws.com/the_vaultx_dao_pfp_1650030637531.gif', description: 'A cool nft collection.', symbol: 'XVLT', supply: 15_000, listings: 0, floor_price: nil, category: 'Utility', website: '#', twitter: '#', discord: '#', volume: 0, volume24: 0)
...
Nft.create(name: 'DeGod #88', price: 28, image: 'https://metadata.degods.com/g/2209.png', rarity: 'Mythic',
           wallet: wallet1, collection: degods, purchase_date: '15.03.2022', mint_address: 'xsfsndjfgagdfcdfdgfdgk87hecs4')
...
Nft.create(name: 'Smoke Head #666', price: 27,
           image: 'https://img-cdn.magiceden.dev/rs:fill:400:400:0:0/plain/https://bafybeiepvcjfm5kppole3ugyrkinfcd4m2efjpdjnlqh3julkadnttqbxi.ipfs.dweb.link/3743.png', rarity: 'Legendary', wallet: wallet2, collection: smokeheads, purchase_date: '31.05.2022', mint_address: '0x0Fd433e474ECB81005ac906e0BCFab66E1d01543')
